...
PROVIDER_SIGNER = [
    ...
    ("Email", EMAIL),
    ("Date", ""),
    ("Notice address", "[Provider notice address]"),
]
...
MSA = Doc(
    ...
    sections=[
        ...
        Section("Services", [
            ...
            C("Provider may use AI-assisted tools to produce Work Product. Provider reviews all such output and remains responsible for the Work Product. Provider will not submit Client Confidential Information to an AI tool that trains on submitted data."),
        ]),
        ...
        Section("Fees and Payment", [
            ...
            C("Deposits are non-refundable once work has started. Provider applies them to work completed."),
        ]),
        Section("Term and Termination", [
            ...
            C("Either Party may terminate an SOW for convenience with 14 days' written notice. Client pays for all Services performed and expenses incurred up to the termination date, including work in progress, at the SOW rates or, for a fixed fee, a proportionate share of it."),
            ...
            C("Sections 5, 7, 8, 9, 10.3 to 10.5, 11, 13 and 14, and any other term that by its nature should survive, survive the end of this Agreement."),
        ]),
        ...
        Section("Limitation of Liability", [
            ...
            C("The limits in this Section do not apply to (a) a Party's breach of Section 8, (b) Client's payment obligations, (c) a Party's gross negligence, fraud or willful misconduct, or (d) a Party's infringement of the other Party's intellectual property."),
        ...
        Section("General", [
            ...
            CL("Entire agreement.", "This Agreement, its Exhibits and each SOW are the entire agreement between the Parties about their subject matter. They replace all earlier proposals, discussions and agreements about it."),
    ...
    exhibits=[
        Section("Exhibit A: Statement of Work", [
            ...
            N("Write each acceptance criterion as a test a reasonable person can run and pass or fail. Acceptance of the last Deliverable is Project Completion under Section 10.2."),
...
WFH = Doc(
    ...
    sections=[
        ...
        Section("Background IP and Third-Party Materials", [
            ...
            CL("License.", "Where Background IP is incorporated into the Work Product, Provider grants Client a perpetual, worldwide, non-exclusive, royalty-free license, irrevocable once Client has paid in full, to use, copy, modify and distribute that Background IP as part of the Work Product for Client's business purposes. Client may transfer this license with the Work Product to a successor or acquirer of Client's business. Client may not sell or license the Background IP on its own."),
        ...
        Section("Provider's Representations", [
            ...
            C("Provider may use AI-assisted tools in creating the Work Product. Provider applies human authorship, review, selection and arrangement to all Work Product and remains responsible for it. Client acknowledges that the copyright status of material generated by an AI tool without human authorship is unsettled, and that Provider does not warrant copyright protection for any such portion."),
        ]),
        Section("Confidentiality", [
        ...
        Section("Warranty and Limitation of Liability", [
            ...
            C("Neither Party is liable to the other for indirect, incidental, special, consequential or punitive damages, or for lost profits, revenue, data or business opportunity. Each Party's total liability arising out of this Agreement is limited to the fees paid under it. These limits do not apply to a breach of Section 7, to Client's payment obligations, or to a Party's gross negligence, fraud or willful misconduct."),
        ]),
        Section("Term and Termination", [
...
COMPANY_SIGNER = [
    ...
    ("Email", EMAIL),
    ("Date", ""),
    ("Notice address", "[Company notice address]"),
]
...
ICA = Doc(
    ...
    sections=[
        ...
        Section("Independent Contractor Status", [
            ...
            CL("Notice required by Colorado law.", "CONTRACTOR IS NOT ENTITLED TO UNEMPLOYMENT INSURANCE BENEFITS UNLESS UNEMPLOYMENT COMPENSATION COVERAGE IS PROVIDED BY CONTRACTOR OR SOME OTHER ENTITY. CONTRACTOR IS OBLIGATED TO PAY FEDERAL AND STATE INCOME TAX ON ANY MONEYS PAID PURSUANT TO THIS AGREEMENT."),
        ]),
        Section("Work Product and Intellectual Property", [
            ...
            CL("AI tools.", "Contractor may use AI-assisted tools only where the Work Order permits them. Contractor will never submit Company or Client Confidential Information to an AI tool that trains on submitted data. Contractor reviews all AI-assisted output and remains responsible for the Work Product."),
        ]),
        Section("Confidentiality", [
        ...
        Section("Client Relationships", [
            ...
            C("Contractor will not use Confidential Information, including a Client's identity, needs, systems, pricing or contacts learned through the Services, to solicit, serve or divert any Client other than through Company. If a Client asks Contractor to work directly for it, Contractor will refer the Client to Company."),
            C("During the term and for 12 months after it, Contractor will not solicit for employment or engagement any employee or contractor of Company that Contractor worked with under this Agreement."),
        ...
        Section("Term and Termination", [
            ...
            C("When this Agreement or a Work Order ends, Contractor delivers all Work Product completed or in progress, returns or deletes Confidential Information under Section 6.3, and deletes credentials under Section 7.6. Company pays for Services performed and accepted up to the end date."),
...
def export_pdf(docx_path: Path) -> Path:
    ...
    staged = WORD_CONTAINER / pdf_path.name
    if staged.exists():
        staged.unlink()
    script = f'''
tell application "Microsoft Word"
  set theDoc to open file name (POSIX file "{docx_path}" as string)
  save as theDoc file name "{staged}" file format format PDF
