...
AI_TOOLS_CLAUSE = (
    "Provider may use AI-assisted tools in creating Work Product. Provider applies human authorship, "
    "review, selection and arrangement to all Work Product and remains responsible for it. Provider "
    "will not submit Client Confidential Information to an AI tool that trains on submitted data. "
    "Client acknowledges that the copyright status of material generated by an AI tool without human "
