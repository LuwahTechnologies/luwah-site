          ...
          <div className="flex flex-col gap-8 text-sm leading-relaxed" style={{ color: "var(--color-text-secondary)" }}>
            ...
            <section>
              ...
              <p>
                ...
                images with a solid color. The agreement PDFs on the Client Agreements page are print exports and are
                not tagged for screen readers. The Word version of each agreement is on the same page and carries the
                full document structure. If any of that is a barrier for you, contact us and we will provide the same
